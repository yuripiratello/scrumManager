...
class History(models.Model):
    ...
    priority = models.IntegerField(blank=True, default=0, help_text='Prioridade da história.')
...
class Task(models.Model):
    ...
    priority = models.IntegerField(blank=True, default=0, help_text='Prioridade da tarefa.')
